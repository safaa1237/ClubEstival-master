...
public class Constants {
    ...
    public static final String ETATRESERVATION = "/views/etatReservation.fxml";
    public static final String LISTERCLIENTREST = "/views/listerClientRestauration.fxml";
    public static final String MainPane = "/views/mainPane.fxml";
    public static final String ACCEUIL = "/views/accueil.fxml";

    //View d'un user non logged in
    public static  final String RESERVERVIEW = "/views/UserViews/reserverView.fxml";
